...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post platforms_url, params: { platform: { nameplatform: @platform.nameplatform, year: @platform.year } }
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { nameplatform: @platform.nameplatform, year: @platform.year } }
